  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p className="leading-relaxed">Oversized T-shirt in soft cotton jersey with a print motif on the front, a round, rib-trimmed neckline and dropped shoulders.</p>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">₹1499</span>
          ...
          <button onClick={()=>{addToCart(slug ,1, 1499, "Relaxed Fit T shirt(L, Black)","L","Black")}} className="flex ml-4 text-white bg-pink-500 border-0 py-2  px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to cart</button>
        ...
        <div className="pin mt-6 flex space-x-2 text-sm">
          <input onChange={onChangePin} placeholder="Enter The Pincode" className='px-2 border-2 border-pink-400 rounded-md' type="text" />
        ...
        {!service && service!=null &&<div className="text-red-700 text-sm mt-3">
         Sorry, Delivery not available on this pincode
        </div>}
        {service && service!=null &&<div className="text-green-700 text-sm mt-3">
         Deliverable at this pincode
        </div>}
      </div>
    </div>
  </div>
